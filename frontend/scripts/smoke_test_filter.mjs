...
const PLANT_ID = "9d69e18f-f4a0-4238-bcf0-216c233221de";
...
await page.goto(`${BASE}/?plant_ids=${PLANT_ID}`, { waitUntil: "networkidle" });
await page.waitForTimeout(1500);
await page.screenshot({ path: `${shotDir}/dashboard-filtered.png` });
